...
namespace _3DTools
{
    ...
    public class InteractiveVisual3D : ModelVisual3D
    {
        ...
        private void SwapInVisualBrush(Material material)
        {
            ...
            while (materialStack.Count > 0)
            {
                ...
                if (currMaterial is DiffuseMaterial)
                {
                    ...
                    if ((Boolean)diffMaterial.GetValue(IsInteractiveMaterialProperty))
                    {
                ...
                else if (currMaterial is EmissiveMaterial)
                {
                    ...
                    if ((Boolean)emmMaterial.GetValue(IsInteractiveMaterialProperty))
                    {
                ...
                else if (currMaterial is SpecularMaterial)
                {
                    ...
                    if ((Boolean)specMaterial.GetValue(IsInteractiveMaterialProperty))
                    {
        ...
        /// </summary>
        internal UIElement InternalVisual => _internalVisual;
        ...
        private static readonly DependencyProperty IsBackVisibleProperty =
            DependencyProperty.Register(
                ...
                typeof(bool),
                typeof(InteractiveVisual3D),
                new PropertyMetadata(false, OnIsBackVisiblePropertyChanged));
