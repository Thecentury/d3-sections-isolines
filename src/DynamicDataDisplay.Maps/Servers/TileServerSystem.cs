namespace Microsoft.Research.DynamicDataDisplay.Charts.Maps
{
    ...
    public sealed class TileServerSystem : DispatcherObject, ITileSystem
    {
        ...
        public string ServerName => sourceServer != null ? sourceServer.ServerName : "not set";
		...
		{
			get => errorsCountToSwitchToOffline;
        ...
        private IWriteableTileServer fileServer;
        ...
        private ITileSystem memoryServer;
        ...
        public BitmapSource this[TileIndex id] => memoryServer[id];
