namespace Microsoft.Research.DynamicDataDisplay.Charts.Maps
{
    ...
    public class NewMap : FrameworkElement, IPlotterElement
    {
        ...
        public TileServerSystem TileSystem => server;

        [NotNull]
        public SourceTileServer SourceTileServer
        {
            get => server.SourceServer;
        ...
        private void DrawImage(BitmapSource bmp, DataRect bounds, TileIndex id)
        {
            ...
            {
                element = freeChildren[freeChildren.Count - 1];
        ...
        {
            get => (bool)GetValue(ChangesTextFormatProperty);
        ...
        protected PhysicalProportionsConstraint ProportionsConstraint => proportionsConstraint;

        MaximalSizeConstraint maxSizeConstraint = new MaximalSizeConstraint();
        protected MaximalSizeConstraint MaxSizeConstraint => maxSizeConstraint;
        ...
        void IPlotterElement.OnPlotterAttached(Plotter plotter)
        {
            ...
            this.plotter.KeyDown += plotter_KeyDown;
        ...
        private void ChangeTextFormat()
        {
            ...
            var cursorGraph = plotter.Children.OfType<CursorCoordinateGraph>().FirstOrDefault();
            if (cursorGraph != null)
            {
