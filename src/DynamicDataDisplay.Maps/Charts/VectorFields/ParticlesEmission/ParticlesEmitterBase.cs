namespace Microsoft.Research.DynamicDataDisplay.Maps.Charts.VectorFields
{
	...
	public abstract class ParticlesEmitterBase : VectorFieldChartBase
	{
		...
		protected TimeSpan prevUpdateTime;
		protected TimeSpan prevEmitTime;
		...
		protected readonly DispatcherTimer timer = new DispatcherTimer(DispatcherPriority.Send) { Interval = TimeSpan.FromMilliseconds(50) };
		...
		private Func<FrameworkElement> createParticle = () => new Ellipse
		{
			Width = 5,
			Height = 5,
			Fill = Brushes.Blue.MakeTransparent(0.2),
			Stroke = Brushes.Blue,
			StrokeThickness = 1
		};
		...
		//new CirclePattern { RadiusRatio = 0.1 };
