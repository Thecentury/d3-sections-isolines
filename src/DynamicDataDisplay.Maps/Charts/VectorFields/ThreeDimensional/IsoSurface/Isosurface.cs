namespace Microsoft.Research.DynamicDataDisplay.Maps.Charts.VectorFields
{
	...
	{
		private readonly GeometryModel3D model = new GeometryModel3D { Material = new SpecularMaterial(Brushes.LightGreen, 10.0) };
		...
		{
			get => (IDataSource3D<double>)GetValue(DataSourceProperty);
		...
		{
			get => (double)GetValue(PotentialProperty);
