namespace Microsoft.Research.DynamicDataDisplay.Maps.Charts.VectorFields
{
	...
	public class ConvolutionStack : ModelVisual3D
	{
		...
		{
			get => (IUniformDataSource3D<Vector3D>)GetValue(DataSourceProperty);
		...
		{
			get => (double)GetValue(SectionHeightProperty);
		...
		{
			get => (double)GetValue(RenderingProgressProperty);
		...
		private void UpdateUI()
		{
			...
			{
				Parallel.For(0, sectionCount, iy =>
				{
					double y = sectionHeight * iy / sectionCount;
		...
		private int renderingFinishedCount;
