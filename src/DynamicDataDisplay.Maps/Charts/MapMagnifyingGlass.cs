namespace Microsoft.Research.DynamicDataDisplay.Charts.Maps
{
	...
	public class MapMagnifyingGlass : ContentGraph
	{
		...
		protected override Panel HostPanel => Plotter2D.ParallelCanvas;
		...
		protected override void OnPlotterAttached()
		{
			...
			SetPlotterBinding(WidthProperty);
			SetPlotterBinding(HeightProperty);
		...
		public ChartPlotter MapPlotter => littlePlotter;
		...
		{
			get => littlePlotter.DataTransform;
