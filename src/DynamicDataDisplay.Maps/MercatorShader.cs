namespace Microsoft.Research.DynamicDataDisplay.Maps
{
	...
	public class MercatorShader : ShaderEffect
	{
		...
		public static readonly DependencyProperty InputProperty =
			RegisterPixelShaderSamplerProperty("Input", typeof(MercatorShader), 0);
		...
		public double YDiff
		{
			get => (double)GetValue(YDiffProperty);
		...
		{
			get => (double)GetValue(YLatMaxProperty);
		...
		{
			get => (double)GetValue(YLatDiffProperty);
