namespace Microsoft.Research.DynamicDataDisplay.Controls
{
	...
	public abstract class GenericValueSelector<T> : SelectorPlotter, INotifyPropertyChanged
	{
		...
		{
			get => ValueConversion.ConvertFromDouble(Marker.Position.X);
			set
			{
		...
		protected override void OnLoaded()
		{
			...
			Marker.SetBinding(ToolTipProperty, new Binding { Source = this, Path = new PropertyPath("SelectedValue") });
		}
		...
		internal AxisBase<T> Axis => (AxisBase<T>)ValueConversion;
