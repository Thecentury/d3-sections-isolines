...
namespace FluidCurrentModelling2.ModellingMath
{
    class FluidCurrentSolver
    {
        ...
        {
            DataSet dataSet = DataSet.Create(ctorString);

            //Инициализируем DataSet
            //CoordinateSystem cs = dataSet.CreateCoordinateSystem("fluidCurrentCS");
