namespace Microsoft.Research.DynamicDataDisplay.Charts
{
	...
	public abstract class ColumnChartBase : IndexedChart
	{
		...
		protected Binding ColumnWidthBinding => columnWidthBinding;

		protected Binding IndexBinding => indexBinding;
		...
		{
			get => (Brush)GetValue(ColumnFillProperty);
		...
		{
			get => (Brush)GetValue(ColumnBorderStrokeProperty);
		...
		{
			get => (double)GetValue(ColumnBorderThicknessProperty);
