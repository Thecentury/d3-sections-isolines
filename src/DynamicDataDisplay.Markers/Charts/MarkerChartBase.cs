namespace Microsoft.Research.DynamicDataDisplay.Charts
{
	...
	using global::DynamicDataDisplay.Markers.DataSources.ValueConverters;
	using global::DynamicDataDisplay.Markers.DataSources.ValueConvertersFactories;
	...
	public abstract class MarkerChartBase : PointChartBase
	{
		...
		{
			get => showMarkersConsequently;
			set => showMarkersConsequently = value;
		}

		private bool getDataAsyncronously;
		public bool GetDataAsyncronously
		{
			get => getDataAsyncronously;
		...
		protected MarkerGenerator CachedMarkerGenerator => markerGenerator;
		...
		{
			get => (Style)GetValue(MarkerStyleProperty);
		...
		protected Dictionary<DependencyProperty, BindingBase> BindingInfos => bindingInfos;
		...
		protected Dictionary<DependencyProperty, DependencyProperty> PropertyMappings => propertyMappings;

		bool commonBindingsAreBuilt;
		...
		{
			get => (DataTemplate)GetValue(MarkerBuilderTemplateProperty);
		...
		{
			get => (MarkerGenerator)GetValue(MarkerBuilderProperty);
