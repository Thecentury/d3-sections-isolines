namespace Microsoft.Research.DynamicDataDisplay.Charts.Selectors
{
	...
	public partial class PointSelector : FrameworkElement, IPlotterElement
	{
		...
		public ICommand RemovePointCommand => removePointCommand;

		protected readonly LambdaCommand changeModeCommand;
		public ICommand ChangeModeCommand => changeModeCommand;

		protected readonly LambdaCommand addPointCommand;
		public ICommand AddPointCommand => addPointCommand;
		...
		public MarkerChartBase MarkerChart => markerChart;
		...
		protected SelectorObservableCollection<Point> ProtectedPoints => points;
		...
		{
			get => (PointSelectorMode)GetValue(ModeProperty);
