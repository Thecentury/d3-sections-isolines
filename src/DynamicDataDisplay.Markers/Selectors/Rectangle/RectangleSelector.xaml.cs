namespace Microsoft.Research.DynamicDataDisplay.Charts.Selectors
{
	...
	public partial class RectangleSelector : FrameworkElement, IPlotterElement
	{
		...
		protected ICommand ChangeModeCommand => changeModeCommand;
		...
		{
			get => (ControlTemplate)GetValue(RectangleTemplateProperty);
		...
		{
			get => (DataRect)GetValue(SelectedRectangleProperty);
		...
		{
			get => (RectangleSelectorMode)GetValue(ModeProperty);
