...
namespace Petzold.Media3D
{
    ...
    public class Cylinder : ModelVisualBase
    {
        ...
        public double Radius1
        {
            ...
            get => (double)GetValue(Radius1Property);
        }
        ...
        public double Fold1
        {
            get => (double)GetValue(Fold1Property);
        ...
        public double Fold2
        {
            get => (double)GetValue(Fold2Property);
        ...
        public int Slices
        {
            ...
            get => (int)GetValue(SlicesProperty);
        }
        ...
        public int EndStacks
        {
            ...
            get => (int)GetValue(EndStacksProperty);
        }
                                            ...
                                            PointCollection textures)
        {
            ...
            for (int stack = 0; stack <= Stacks; stack++)
            {
                ...
                Vector3D vectRadius = radius * vectRearRadius;
                Point3D center = Point1 + stack * vectCylinder / Stacks;
