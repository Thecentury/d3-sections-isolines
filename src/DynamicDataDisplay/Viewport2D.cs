namespace Microsoft.Research.DynamicDataDisplay
{
    ...
    public partial class Viewport2D : DependencyObject
    {
        ...
        public Rect Output => (Rect)GetValue(OutputProperty);
        ...
        {
            get => (DataRect)GetValue(UnitedContentBoundsProperty);
        ...
        {
            get => (DataRect)GetValue(VisibleProperty);
            set 
            {
