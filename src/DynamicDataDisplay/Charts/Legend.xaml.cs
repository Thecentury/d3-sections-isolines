namespace Microsoft.Research.DynamicDataDisplay
{
	...
	public partial class Legend : ContentControl, IPlotterElement
	{
		...
		{
			get => (double)GetValue(LegendLeftProperty);
		...
		{
			get => (double)GetValue(LegendRightProperty);
		...
		{
			get => (double)GetValue(LegendBottomProperty);
		...
		{
			get => (double)GetValue(LegendTopProperty);
		...
		public Panel ContentPanel => stackPanel;
		...
		{
			if (stackPanel.Children.Count > 0 && ReadLocalValue(VisibilityProperty) == DependencyProperty.UnsetValue && autoShowAndHide)
			{
				Visibility = Visibility.Visible;
			}
			else if (stackPanel.Children.Count == 0 && ReadLocalValue(VisibilityProperty) != DependencyProperty.UnsetValue && autoShowAndHide)
			{
