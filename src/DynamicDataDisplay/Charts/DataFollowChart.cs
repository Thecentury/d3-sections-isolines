namespace Microsoft.Research.DynamicDataDisplay.Charts
{
	...
	public class DataFollowChart : ViewportHostPanel, INotifyPropertyChanged
	{
		...
		{
			get => (PointsGraphBase)GetValue(PointSourceProperty);
		...
		public int ClosestPointIndex => (int)GetValue(ClosestPointIndexProperty);
		...
		public Point MarkerPosition => (Point)GetValue(MarkerPositionProperty);
