namespace Microsoft.Research.DynamicDataDisplay.Charts
{
	...
	public class VoronoiChart : FrameworkElement, IPlotterElement
	{
		...
		private class Segment : IEquatable<Segment>
		{
			...
			{
				if (InfinityPoint == InfinityPoint.End || InfinityPoint == InfinityPoint.None)
					return Start;
				return End;
			}
			...
			{
				if (InfinityPoint == InfinityPoint.Start)
					return Start;
				if (InfinityPoint == InfinityPoint.End)
					return End;
				throw new InvalidOperationException("Segment doesn't have infinity point.");
			}

			public bool HasInfinityPoint => InfinityPoint != InfinityPoint.None;
