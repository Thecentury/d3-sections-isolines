...
namespace Microsoft.Research.DynamicDataDisplay.Charts.Isolines
{
    ...
    public abstract class IsolineGraphBase : ContentGraph
    {
		...
		{
			get => (IsolineCollection)GetValue(IsolineCollectionProperty);
        ...
        {
            get => (double)GetValue(WayBeforeTextMultiplierProperty);
        ...
        {
            get => (string)GetValue(LabelStringFormatProperty);
		...
		{
			get => (double)GetValue(LabelsScalingProperty);
        ...
        {
            get => (double)GetValue(MissingValueProperty);
