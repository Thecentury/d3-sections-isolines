...
/*            
		...
		#region SubCells
		public ValuesInCell LeftTopCell => new ValuesInCell(Left, Center, Top, LeftTop);

		public ValuesInCell RightTopCell => new ValuesInCell(Center, Right, RightTop, Top);

		public ValuesInCell RightBottomCell => new ValuesInCell(Bottom, RightBottom, Right, Center);

		public ValuesInCell LeftBottomCell => new ValuesInCell(LeftBottom, Bottom, Center, Left);
